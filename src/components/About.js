      ...
      <section className="about-me">
        <div className="container">
          <div className="row no-gutters">
            ...
            <div className="col-5 experience">

              <div className="row no-gutters title">
                <div className="col-3 date"></div>
                <div className="col-9"><h2>// my <span>experience</span></h2></div>
              </div>{/* END .row */}

              <div className="row no-gutters">
                <div className="col-3 date">09.14 - Today</div>
                <div className="col-9"><strong>Swift Communications</strong> | <span>Remote</span><br/>
                  WordPress Developer</div>
              </div>{/* END .row */}

              <div className="row no-gutters">
                <div className="col-3 date">06.10 - 09.14</div>
                <div className="col-9"><strong>Independent Contractor</strong> | <span>Remote</span><br/>
                  Web Developer</div>
              </div>{/* END .row */}

              <div className="row no-gutters">
                <div className="col-3 date">10.07 - 06.10</div>
                <div className="col-9"><strong>Resort Group</strong> | <span>Steamboat Springs, CO</span><br/>
                  Internet Marketing Specialist</div>
              </div>{/* END .row */}

              <div className="row no-gutters">
                <div className="col-3 date">11.06 - 10.07</div>
                <div className="col-9"><strong>Sunday River</strong> | <span>Newry, ME</span><br/>
                  Internet Marketing Specialist</div>
              </div>{/* END .row */}
              ...
              <div className="row no-gutters">
                <div className="col-3 date">09.02 - 05.06</div>
                <div className="col-9"><strong>The University of Maine </strong> | <span>Orono, ME</span><br/>
              ...
              <div className="row no-gutters">
                <div className="col-3 date"></div>
                <div className="col-9"><a class="btn btn-primary" href="#" role="button">Resume</a></div>
              </div>{/* END .row */}
